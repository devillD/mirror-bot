...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = f'qmirror{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'qunzipmirror{CMD_INDEX}'
        self.QbZipMirrorCommand = f'qzipmirror{CMD_INDEX}'
        ...
        self.QbLeechCommand = f'qleech{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'qunzipleech{CMD_INDEX}'
        self.QbZipLeechCommand = f'qzipleech{CMD_INDEX}'
