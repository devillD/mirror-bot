...
class _BotCommands:
    def __init__(self):
        ...
        self.qMirrorCommand = f'qmirror{CMD_INDEX}'
        self.qUnzipMirrorCommand = f'qunzipmirror{CMD_INDEX}'
        self.qZipMirrorCommand = f'qzipmirror{CMD_INDEX}'
        ...
        self.qLeechCommand = f'qleech{CMD_INDEX}'
        self.qUnzipLeechCommand = f'qunzipleech{CMD_INDEX}'
        self.qZipLeechCommand = f'qzipleech{CMD_INDEX}'
